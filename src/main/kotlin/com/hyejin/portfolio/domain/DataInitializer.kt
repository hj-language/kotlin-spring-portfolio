package com.hyejin.portfolio.domain

import com.hyejin.portfolio.domain.contant.SkillType
import com.hyejin.portfolio.domain.entity.*
import com.hyejin.portfolio.domain.repository.*
...
class DataInitializer(
    ...
    fun initializeData() {
        ...
        val account = Account(
            loginId = "admin1",
            pw = "\$2a\$10\$BOY2cP6xzaA7NF2q7i5Bsu.DxFVppNtxkGNxbjZw.uAxJp9hQl0LS"
        )
